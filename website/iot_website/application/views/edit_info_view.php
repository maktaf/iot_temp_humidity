    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-edit"></i> Edit System Information</div>
        <div class="card-body">
        <?php echo form_open('EditInfo'); ?>
            <div class="form-group">
              <label for="exampleInputEmail1">Name</label>
              <input name="text" type="name" class="form-control"  aria-describedby="emailHelp" value="<?php echo $name ?>" placeholder="Enter Name">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Email address</label>
              <input value="<?php echo $email ?>" type="email" name="email" class="form-control" id="exampleInputEmail1" placeholder="Enter Email address ...">
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Minimum Temperature</label>
              <input name="min_temp" value="<?php echo $min_temp ?>" type="text" class="form-control"  placeholder="Enter Minimum Temperature...">
              <small id="emailHelp" class="form-text text-muted">We'll warn you if Temperature went below this value.</small>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Maximum Temperature</label>
              <input name="max_temp" value="<?php echo $max_temp ?>" type="text" class="form-control"  placeholder="Enter Maximum Temperature...">
              <small id="emailHelp" class="form-text text-muted">We'll warn you if Temperature went over this value.</small>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Minimum Humidity</label>
              <input name="min_humidity" value="<?php echo $min_humidity ?>" type="text" class="form-control" placeholder="Enter Minimum Humidity...">
              <small id="emailHelp" class="form-text text-muted">We'll warn you if Humidity went below this value.</small>
            </div>
            <div class="form-group">
              <label for="exampleInputPassword1">Maximum Humidity</label>
              <input type="text" name="max_humidity" value="<?php echo $max_humidity ?>" class="form-control"  placeholder="Enter Maximum Humidity...">
              <small id="emailHelp" class="form-text text-muted">We'll warn you if Humidity went over this value.</small>
            </div>
